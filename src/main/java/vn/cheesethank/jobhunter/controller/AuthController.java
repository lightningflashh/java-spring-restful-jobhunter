...
import vn.cheesethank.jobhunter.domain.request.ReqLoginDTO;
import vn.cheesethank.jobhunter.domain.response.ResCreateUserDTO;
import vn.cheesethank.jobhunter.domain.response.ResLoginDTO;
...
public class AuthController {
        ...
        public ResponseEntity<ResCreateUserDTO> registerNewUser(@Valid @RequestBody User user)
                        throws IdInvalidException {
